...
ieee802_1x_generic_announcement_timeout(void *eloop_ctx, void *timeout_ctx)
{
	...
	sta->eapol_sm->eapol->cb.eapol_send(
		...
		(u8 *) &announcement, sizeof(announcement));
			...
			size_t len)
{
	...
	case IEEE802_1X_TYPE_EAPOL_MKA:
		/* leave MKPDU handling to KaY L2 */
		break;

	case IEEE802_1X_TYPE_EAPOL_ANNOUNCEMENT_GENERIC:
		wpa_printf(MSG_DEBUG, "   EAPOL-Announcement (Generic)");
		/* TODO: implement support for this; show data */
		break;

	case IEEE802_1X_TYPE_EAPOL_ANNOUNCEMENT_SPECIFIC:
		wpa_printf(MSG_DEBUG, "   EAPOL-Announcement (Specific)");
		/* TODO: implement support for this; show data */
		break;
