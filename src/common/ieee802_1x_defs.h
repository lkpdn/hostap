...
enum { IEEE802_1X_NO_ACCESS         = 0,
       IEEE802_1X_REMEDIAL_ACCESS   = 1,
       IEEE802_1X_RESTRICTED_ACCESS = 2,
       IEEE802_1X_EXPECTED_ACCESS   = 3,
};

enum { IEEE802_1X_UNAUTH_NO_ACCESS       = 0,
       IEEE802_1X_UNAUTH_FALLBACK_ACCESS = 1,
       IEEE802_1X_UNAUTH_LIMITED_ACCESS  = 2,
       IEEE802_1X_UNAUTH_OPEN_ACCESS     = 3,
};
